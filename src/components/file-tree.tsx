...
const Div = styled.div<{
    ...
    background-color: ${props => props.isSelected ? "#e8e8e8" : "transparent"}; // Lighter background for selection
    color: ${props => props.isSelected ? "#000" : "#000"}; // Dark text for better readability

    :hover {
        cursor: pointer;
        background-color: #e2e2e2; // Slightly darker gray on hover for light theme
        color: #000; // Keep text color dark for contrast
    }
`
